...
public class LoadingDialog extends DialogFragment {
    ...
    public static LoadingDialog newInstance(boolean dimable) {
    ...
    public static LoadingDialog newInstance(boolean dimable, String msg) {
...
//        lp.gravity = Gravity.BOTTOM;
        ...
        lp.width = lp.height = (int) (DensityUtils.getScreenWidth(getActivity()) * 0.3);
