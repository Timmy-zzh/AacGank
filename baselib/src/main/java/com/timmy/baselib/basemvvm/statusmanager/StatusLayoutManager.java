package com.timmy.baselib.basemvvm.statusmanager;
...
public class StatusLayoutManager {
    ...
    private void createEmptyLayout() {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onStatusChildClickListener.onRetryClick(view);
            }
        });
    ...
    public static final class Builder {
        ...
        public Builder(@NonNull View contentLayout) {
            ...
            this.emptyClickViewTextColor = contentLayout.getContext().getResources().getColor(R.color.T_99);
            this.isErrorClickViewVisible = true;
            this.errorClickViewTextColor = contentLayout.getContext().getResources().getColor(R.color.T_99);
            // 设置默认背景色
//            this.defaultBackgroundColor = contentLayout.getContext().getResources().getColor(R.color.T_99);
            this.defaultBackgroundColor = android.R.color.transparent;
        }
