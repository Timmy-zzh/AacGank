package com.timmy.baselib.adapterlib.listener;
...
import com.timmy.baselib.adapterlib.BaseMultiItemQuickAdapter;
...
//                mPressedView.setPressed(true);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        return (type == BaseMultiItemQuickAdapter.EMPTY_VIEW ||
                type == BaseMultiItemQuickAdapter.HEADER_VIEW ||
                type == BaseMultiItemQuickAdapter.FOOTER_VIEW ||
                type == BaseMultiItemQuickAdapter.LOADING_VIEW);
    }
