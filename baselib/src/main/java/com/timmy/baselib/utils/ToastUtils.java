...
public final class ToastUtils {
    ...
    ///////////////////////////showResult()/////////////////////
    public static void showResult(BaseResult result) {
        if (result != null && !TextUtils.isEmpty(result.getMsg())) {
            showShort(result.getMsg());
        }
    }

    public static void showErrorResult(BaseResult result) {
        if (result != null && !result.isSuccess() && !TextUtils.isEmpty(result.getMsg())) {
            showShort(result.getMsg());
        }
    }
