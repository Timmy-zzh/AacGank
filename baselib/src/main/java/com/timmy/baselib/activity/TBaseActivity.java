...
/**
 * Activity基类:只处理加载Dialog显示,状态栏,和aac框架mDisposable初始化
 * 下分两个子类:使用ButterKnife生成控件和使用DataBinding技术Activity
 */
public abstract class TBaseActivity extends AppCompatActivity implements ILoadingView {
