package com.timmy.thirdframework.permissions.core;
 ...
 * 工具activity
 */
public class TPermissionActivity extends Activity {
    ...
    public static void requestPermission(Context context, String[] permissions, int requestCode, IPermission iPermission) {
        ...
        Intent intent = new Intent(context, TPermissionActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // 权限申请
        setContentView(R.layout.activity_tpermission);
